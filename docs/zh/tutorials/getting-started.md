...
> **想让 AI 直接帮你构建？** 两条可复制提示词见[与你的 AI 助手一起构建](../build-with-ai.md)。
...
- 更多可运行示例,参见仓库中的 [`examples/`](https://github.com/qorm/platform/tree/main/examples)(counter / todo / dashboard / hardware / …)。
