...
var All = []Cap{
	...
	{Stem: "screenrecord", Widget: "screenrecord", Ops: []string{"screenRecordStart", "screenRecordStop"}, Callback: "qormOnScreenRecord", Platforms: []string{IOS, Android, Mac, Web}, Desc: "Record the screen.", Notes: "Android uses MediaProjection (needs a foreground service with type mediaProjection on Android 14+)"},
...
var perms = map[string]map[string][]string{
	...
	"screenrecord": {Android: {"android.permission.FOREGROUND_SERVICE", "android.permission.FOREGROUND_SERVICE_MEDIA_PROJECTION"}},
