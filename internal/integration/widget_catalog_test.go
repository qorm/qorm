...
var allWidgetTypes = []string{
	...
	"banner", "battery", "biometric", "bluetooth", "bottomnav", "bottomnavigationbar", "breadcrumb", "brightness",
	...
	"filepicker", "filterchip", "fingerprint", "flashlight", "floatingactionbutton", "formfield", "geolocation", "gesture",
	...
	"navigationrail", "network", "nfc", "notify", "openlink", "openurl", "orientation", "pageview",
