...
var allWidgetTypes = []string{
	...
	"backbutton", "banner", "battery", "biometric", "bluetooth", "bottomappbar", "bottomnav", "bottomnavigationbar", "bottomsheet", "breadcrumb", "brightness",
	...
	"deviceinfo", "dialog", "dismissible", "displays", "divider", "dockbadge", "draggable", "draggablescrollablesheet", "draggablesheet", "dragtarget", "drawer", "droptarget", "dropdown",
	...
	"listtile", "location", "loginitem", "materialstepper", "menu", "metric", "modal", "modalbottomsheet",
	"monthview", "calendarview", "datepickercalendar", "tooltip", "navigationbar",
	...
	"share", "sheet", "skeleton", "slider", "slidingsegmentedcontrol", "sliverappbar", "snackbar", "spacer", "speak",
